...
import com.ftbicolor.network.FTBIColorNetwork;
...
@Mod(FTBIColorConstants.MOD_ID)
public class FTBIColor {
	public static final String MOD_ID = FTBIColorConstants.MOD_ID;
